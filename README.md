...
**Status:** early development. The public API and design doc are in place; the MPMC
protocol, stress-test suite, and benchmark harness are landing incrementally.
